...
export default function HomeScreen() {
  ...
  const fetchMyWeatherData = async () => {
    ...
    let cityName = myCity || 'Cairo'; // Default to Cairo if no city is stored
    fetchWeatherForecast({
      cityName,
      days: '7',
    }).then((data) => {
          ...
          <SafeAreaView className="flex flex-1">
            ...
            <View style={{ height: '7%' }} className="mx-4 relative z-50">
              <View
                ...
                style={{ backgroundColor: showSearch ? themeColors.bgWhite(0.2) : 'transparent' }}>
                  ...
                  weather?.forecast?.forecastday?.map((item, index) => {
                    ...
                    return (
                      <View
                        ...
                        style={{ backgroundColor: themeColors.bgWhite(0.15) }}
                      >
                        <Image
